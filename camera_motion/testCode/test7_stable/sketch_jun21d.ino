...
int pictureNumber = 0; // variable to hold the picture number
...
//   // Write 0 back to the first byte of the EEPROM
//   EEPROM.write(0, 0);
...
void loop() {
  ...
  if(!file){
    ...
    // Write the incremented picture number back to EEPROM
  ...
  // Add a delay to control how often pictures are taken
