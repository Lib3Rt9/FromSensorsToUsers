...
void IRAM_ATTR captureImage() {
  ...
  // path refers to the path where you want to save the image
  String path = "/picture" + String(random(1000, 5000)) + ".jpg";
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(MOTION_SENSOR_PIN), captureImage, RISING);  
